...
CLASS lcl_handler IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity        TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_840,
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF ZRAP100_R_TravelTP_840 IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_840 IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
